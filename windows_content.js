...
fetch(proxyurl + arr[count]) // https://cors-anywhere.herokuapp.com/https://example.com
...
fetch(proxyurl + arr[1]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[1])
...
fetch(proxyurl + arr[2]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[2])
...
fetch(proxyurl + arr[3]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[3])
...
fetch(proxyurl + arr[4]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[4])
...
fetch(proxyurl + arr[5]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[5])
...
fetch(proxyurl + arr[6]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[6])
...
fetch(proxyurl + arr[7]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[7])
...
fetch(proxyurl + arr[8]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[8])
...
fetch(proxyurl + arr[9]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[9])
...
fetch(proxyurl + arr[10]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[10])
...
fetch(proxyurl + arr[11]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[11])
...
fetch(proxyurl + arr[12]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[12])
...
fetch(proxyurl + arr[13]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[13])
...
fetch(proxyurl + arr[14]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[14])
...
fetch(proxyurl + arr[15]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[15])
...
fetch(proxyurl + arr[16]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[16])
...
fetch(proxyurl + arr[17]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[17])
...
fetch(proxyurl + arr[18]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[18])
...
fetch(proxyurl + arr[19]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[19])
...
fetch(proxyurl + arr[20]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[20])
...
fetch(proxyurl + arr[21]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[21])
...
fetch(proxyurl + arr[22]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[22])
...
fetch(proxyurl + arr[23]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[23])
...
fetch(proxyurl + arr[24]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[24])
...
fetch(proxyurl + arr[25]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[25])
...
fetch(proxyurl + arr[26]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[26])
...
fetch(proxyurl + arr[27]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[27])
...
fetch(proxyurl + arr[28]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[28])
...
fetch(proxyurl + arr[29]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[29])
...
fetch(proxyurl + arr[30]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[30])
...
fetch(proxyurl + arr[31]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[31])
...
fetch(proxyurl + arr[32]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[32])
...
fetch(proxyurl + arr[33]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[33])
...
fetch(proxyurl + arr[34]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[34])
...
fetch(proxyurl + arr[35]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[35])
...
fetch(proxyurl + arr[36]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[36])
...
fetch(proxyurl + arr[37]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[37])
...
fetch(proxyurl + arr[38]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[38])
...
fetch(proxyurl + arr[39]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[39])
...
fetch(proxyurl + arr[40]) // https://cors-anywhere.herokuapp.com/https://example.com
.then(response => response.text())
//START OF FUNCTION IN FETCH
.then(contents => {
		console.log(arr[40])
